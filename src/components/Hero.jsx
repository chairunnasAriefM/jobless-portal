...
// Ganti dengan path gambar Anda atau gunakan URL online
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-6">
          The <span className="text-orange-400">#1 Job Site</span> to Find
          <br className="hidden md:block" /> Remote Jobs. No Ads, Scams, or Junk.
        </h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
          <a
            href="#find-jobs" // Arahkan ke section pencarian nanti
