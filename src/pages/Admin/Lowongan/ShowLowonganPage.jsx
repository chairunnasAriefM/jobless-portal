...
import { Loader2, AlertCircle, ArrowLeft, Briefcase, MapPin, DollarSign, Calendar, CheckCircle, XCircle,Edit } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                <div className="flex items-center gap-4">
                    <Link to="/admin/lowongan" className="p-2 rounded-full hover:bg-slate-200 transition-colors">
                ...
                <Link to={`/admin/lowongan/edit/${job.lowongan_id}`} className="bg-orange-500 text-white font-semibold py-2.5 px-5 rounded-lg hover:bg-orange-600 transition-colors flex items-center self-start sm:self-center">
                    <Edit size={16} className="mr-2" /> Edit Lowongan
                </Link>
            </div>
